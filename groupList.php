...
<body>
	...
	$userid = $_GET['userid'];
        ...
        if($numOfAccs == 0)
            ...
            print "<tr><td style='border: none;'>List of Groups</td></tr><tr><td>Group</td><td>Group Owner</td></tr>";
            while($row = mysql_fetch_array($result, MYSQL_NUM))
                print("<tr>
                        <td>".$row[0]."</td>
                        <td>".$row[1]."</td>
                        <td><a href='addToGroup.php?userid=".$userid."&group=".$row[0]."'>Add to Group</a></td></tr>");
        }
        print   "</table>";
    ?>
    </div>
